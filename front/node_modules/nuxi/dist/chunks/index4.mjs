...
import { p as pathKeyExports, a as mergeStream$1, b as crossSpawnExports } from '../shared/nuxi.f7bdc5b2.mjs';
...
Object.defineProperty(signals$2,"__esModule",{value:true});signals$2.getSignals=void 0;var _os$1=require$$0$1;
...
const platformLib = (() => {
	switch (process$1$1.platform) {
		case 'darwin':
			return clipboard$2;
		case 'win32':
			return clipboard$1;
		case 'android':
			if (process$1$1.env.PREFIX !== '/data/data/com.termux/files/usr') {
