...
import { v as version, n as name } from './nitro.25665fa1.mjs';
...
async function updatePackageJSON(nitro) {
  ...
  await writePackageJSON(packageJSONPath, {
    ...
    dependencies: Object.fromEntries(
      ...
      }).filter((e) => e[0] !== "fsevents").sort(([a], [b]) => a[0].localeCompare(b[0]))
    ),
    engines: {
...
export { GLOB_SCAN_PATTERN as G, createNitro as a, build as b, copyPublicAssets as c, scanMiddleware as d, scanServerRoutes as e, scanPlugins as f, defineNitroPreset as g, compressPublicAssets as h, writeFile$1 as i, loadOptions as l, nitroRuntimeDependencies as n, prepare as p, scanHandlers as s, writeTypes as w };
